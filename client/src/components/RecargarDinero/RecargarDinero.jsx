...
function CargarDinero ({usuarioConectado, getProfile})  {
  ...
  useEffect(() => {
   ...
   return (  
    <Container id="recargardinerocont">  
        <Image id="headerrecargar" src="https://fotos.subefotos.com/aa324d0c240f9d3358f4ddce34a14118o.png" ></Image>
        ...
        <div className="confirmar">
          <Button id="buttonrecargar" className="btn btn-dark" onClick={cargarDinero(usuarioConectado.id)}  >Confirmar Recarga</Button>
        </div>
        </div>
        <Image id="footerrecargar" src="https://fotos.subefotos.com/0d5c65b0be7d80bce6ee2187e71c9997o.png" ></Image>
    </Container>
  )
}
