  ...
  const handlerClick = () => {
    ...
    return(
        <Container id="resetpasscontainer">
            <Image id="headerresetpass" src="https://fotos.subefotos.com/beae292ac669e32496a3b392aadf27e6o.png" ></Image>
            ...
            <Image id="footerresetpass" src="https://fotos.subefotos.com/0d5c65b0be7d80bce6ee2187e71c9997o.png" ></Image>
        </Container>
    )
}
